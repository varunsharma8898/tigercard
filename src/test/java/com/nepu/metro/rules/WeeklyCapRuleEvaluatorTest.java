...
public class WeeklyCapRuleEvaluatorTest {

    WeeklyCapRuleEvaluator ruleEvaluator;
    ...
    @Before
    public void setUp() {
        ruleEvaluator = new WeeklyCapRuleEvaluator(null);
    ...
    @Test
    public void testDoEvaluate_WeeklyCapReached() {
        context.setTotalWeeklyFareAmount(100);
        ruleEvaluator.doEvaluate(context, fare);
        Assert.assertEquals(0, fare.getAmount());
    }

    @Test
    public void testDoEvaluate_FareLargerThanWeeklyCap() {
        Fare newFare = new Fare(10);
        context.setTotalWeeklyFareAmount(95);
        context.setApplicableWeeklyLimit(100);
